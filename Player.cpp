...
// 	cout << endl;
// 	cout << " 对于 [" << player_equip[num_eq-1] << "] 你打算 :" << endl;
// 	cout << "1. 使用该物品" << endl;
// 	cout << "2. 查看该物品属性" << endl;
// 	cout << "3. 卸下该装备" << endl;
// 	cout << "4. 丢弃该物品 " << endl;
...
// 		this->p->Player_AbilityofLearn+=player_equip->equip.Player_AbilityofLearn;  //学习力 
// 		this->p->Player_AbilityofProgramming += player_equip->equip.AbilityofProgramming;  //编程能力值 
// 		this->p->Player_AbilityofMath += player_equip->equip.Player_AbilityofMath; // 数学能力值 
// 		this->p->Player_AbilityofLogic += player_equip->equip.Player_AbilityofLogic;  //逻辑能力值 
// 		this->p->Player_AbilityofPractice += player_equip->equip.Player_AbilityofPractice;  //实践能力值 
// 		player_equip[num_eq - 1]->show;
// 	}
// 	else if (flag_eq == 2)
// 	{
// 		player_equip[num_eq-1]->show();
